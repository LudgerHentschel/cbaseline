...
html_title = f"CBaseline {release}"
html_theme_options = {"github_url": "https://github.com/LudgerHentschel/cbaseline", "show_prev_next": True, "navbar_center": []}
html_static_path = []
...
html_baseurl = "https://ludgerhentschel.github.io/cbaseline/"
